...
let player1name = $fieldName1.value//valor do input player 1 e 2
let player2name = $fieldName2.value
...
function printWinnerPlayer(){
    if(winner === "X"){
        $winnerRound.textContent =  "1 ganhou"
    }else if(winner === "O"){
        $winnerRound.textContent =  "2 ganhou"
    }
}
